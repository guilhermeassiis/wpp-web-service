...
var Sender = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        phoneNumber = (_a = (0, libphonenumber_js_1.parsePhoneNumber)(to, "BR")) === null || _a === void 0 ? void 0 : _a.format("E.164").replace('+', '');
    ...
    Sender.prototype.initialize = function () {
        ...
        var start = function (client) { return __awaiter(_this, void 0, void 0, function () {
        ...
        (0, venom_bot_1.create)("ws-sender-hw", qr, status)
            .then(function (client) { return start(client); })["catch"](function (error) { return console.error(error); });
    };
    return Sender;
}());
